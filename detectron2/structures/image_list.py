...
class ImageList(object):
    """
    Structure that holds a list of JPEGImages (of possibly
    varying sizes) as a single tensor.
    This works by padding the JPEGImages to the same size.
    ...
    def from_tensors(
        ...
        if len(tensors) == 1:
            ...
            # TODO: check whether it's faster for multiple JPEGImages as well
