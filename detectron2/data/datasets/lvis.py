...
def load_lvis_json(json_file, image_root, dataset_name=None, extra_annotation_keys=None):
    ...
    Args:
        ...
        image_root (str): the directory where the JPEGImages in this json file exists.
    ...
    logger.info("Loaded {} JPEGImages in the LVIS format from {}".format(len(imgs_anns), json_file))
