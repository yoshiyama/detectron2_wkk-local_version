...
def load_coco_panoptic_json(json_file, image_dir, gt_dir, meta):
    ...
    for ann in json_info["annotations"]:
        ...
        # different extension, and JPEGImages have extension ".jpg" for COCO. Need
    ...
    assert len(ret), f"No JPEGImages found in {image_dir}!"
...
def register_coco_panoptic(
    ...
    Args:
        ...
        image_root (str): directory which contains all the JPEGImages
        panoptic_root (str): directory which contains panoptic annotation JPEGImages in COCO format
...
def register_coco_panoptic_separated(
    ...
    Args:
        ...
        metadata (dict): extra metadata associated with this dataset.
        image_root (str): directory which contains all the JPEGImages
        panoptic_root (str): directory which contains panoptic annotation JPEGImages
