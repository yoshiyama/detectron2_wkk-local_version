...
class RepeatFactorTrainingSampler(Sampler):
    ...
    def repeat_factors_from_category_frequency(dataset_dicts, repeat_thresh):
        ...
        as the fraction of JPEGImages in the training set (without repeats) in which category c
        appears.
        ...
        """
        # 1. For each category c, compute the fraction of JPEGImages that contain it: f(c)
    ...
    def _get_epoch_indices(self, generator):
        ...
        # Construct a list of indices in which we repeat JPEGImages as specified
        indices = []
