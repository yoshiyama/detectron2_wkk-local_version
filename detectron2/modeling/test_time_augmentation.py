...
class DatasetMapperTTA:
    ...
    and returns a list of dataset dicts where the JPEGImages
    ...
    def __init__(self, min_sizes: List[int], max_size: int, flip: bool):
        ...
        Args:
            ...
            max_size: maximum height or width of resized JPEGImages
...
class GeneralizedRCNNWithTTA(nn.Module):
    ...
    def __init__(self, cfg, model, tta_mapper=None, batch_size=3):
        ...
        Args:
            ...
            batch_size (int): batch the augmented JPEGImages into this batch size for inference.
        """
        super().__init__()
    ...
    def _get_augmented_boxes(self, augmented_inputs, tfms):
        # 1: forward with all augmented JPEGImages
