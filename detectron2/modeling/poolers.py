...
def assign_boxes_to_levels(
    ...
    Args:
        box_lists (list[Boxes] | list[RotatedBoxes]): A list of N Boxes or N RotatedBoxes,
            where N is the number of JPEGImages in the batch.
    ...
    Returns:
        A tensor of length M, where M is the total number of boxes aggregated over all
            N batch JPEGImages. The memory layout corresponds to the concatenation of boxes
            from all JPEGImages. Each element is the feature map index, as an offset from
...
def convert_boxes_to_pooler_format(box_lists: List[Boxes]):
    ...
    Args:
        box_lists (list[Boxes] | list[RotatedBoxes]):
            A list of N Boxes or N RotatedBoxes, where N is the number of JPEGImages in the batch.
    ...
    def forward(self, x: List[torch.Tensor], box_lists: List[Boxes]):
        ...
        Returns:
            Tensor:
                ...
                boxes aggregated over all N batch JPEGImages and C is the number of channels in `x`.
        """
