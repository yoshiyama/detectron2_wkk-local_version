...
class DenseDetector(nn.Module):
        ...
        *,
        ...
        Args:
            ...
            pixel_mean (Tuple[float]):
                ...
                To train on JPEGImages of different number of channels, set different mean & std.
    ...
    def preprocess_image(self, batched_inputs: List[Dict[str, Tensor]]):
        """
        Normalize, pad and batch the input JPEGImages.
        """
    ...
    def _transpose_dense_predictions(
        ...
        Args:
            predictions: a list of outputs, each is a list of per-level
                ...
                number of JPEGImages, Ai is the number of anchors per location on
    ...
    def visualize_training(self, batched_inputs, results):
        """
        A function used to visualize ground truth JPEGImages and final network predictions.
        It shows ground truth bounding boxes on the original image and up to 20
        predicted object bounding boxes on the original image.

        Args:
            batched_inputs (list): a list that contains input to the model.
            results (List[Instances]): a list of #JPEGImages elements returned by forward_inference().
        """
