...
class DataForMaskLoss:
    """
    Contains mask GT and estimated data for proposals from multiple JPEGImages:
    """
...
class MaskLoss:
    ...
    def __call__(
        ...
        # densepose outputs are computed for all JPEGImages and all bounding boxes;
        # i.e. if a batch has 4 JPEGImages with (3, 1, 2, 1) proposals respectively,
