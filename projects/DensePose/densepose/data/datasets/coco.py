...
DATASETS = [
    ...
    CocoDatasetInfo(
        ...
        images_root="densepose_chimps/JPEGImages",
...
def load_coco_json(annotations_json_file: str, image_root: str, dataset_name: str):
    ...
    image_root: str
        directory that contains all the JPEGImages
    dataset_name: str
    ...
    logger = logging.getLogger(__name__)
    logger.info("Loaded {} JPEGImages in COCO format from {}".format(len(imgs), annotations_json_file))
    # anns is a list[list[dict]], where each dict is an annotation
    # record for an object. The inner list enumerates the objects in an image
    # and the outer list enumerates over JPEGImages.
