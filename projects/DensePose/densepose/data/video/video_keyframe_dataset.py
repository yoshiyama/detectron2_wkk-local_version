    ...
    def __init__(
        ...
        Args:
            ...
            transform (Callable: torch.Tensor -> torch.Tensor):
                transforms a batch of RGB JPEGImages (tensors of size [B, 3, H, W]),
    ...
    def __getitem__(self, idx: int) -> Dict[str, Any]:
        ...
        Returns:
            A dictionary containing two keys:
                JPEGImages (torch.Tensor): tensor of size [N, H, W, 3] or of size
        ...
        if not keyframes:
            return {"JPEGImages": self._EMPTY_FRAMES, "categories": []}
        ...
        return {"JPEGImages": frames, "categories": categories}
