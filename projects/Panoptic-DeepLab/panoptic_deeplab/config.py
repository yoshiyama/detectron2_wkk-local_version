...
def add_panoptic_deeplab_config(cfg):
    ...
    # This is the padding parameter for JPEGImages with various sizes. ASPP layers
    # requires input JPEGImages to be divisible by the average pooling size and we
    # can use `MODEL.PANOPTIC_DEEPLAB.SIZE_DIVISIBILITY` to pad all JPEGImages to
